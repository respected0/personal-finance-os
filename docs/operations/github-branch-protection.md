...
Branch protection requires all seven checks to pass on the latest commit and
...
- Require the seven status checks above and require branches to be up to date.
